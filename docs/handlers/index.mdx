...
- [awsLambdaHandler](./aws-lambda-handler.md) - Invoke AWS Lambda functions
- [mcpServerHandler](./mcp-server-handler.md) - Model Context Protocol server
  handler
- [openApiSpecHandler](./openapi-spec-handler.md) - Serve OpenAPI specifications
- [redirectHandler](./redirect-handler.md) - HTTP redirects
- [urlForwardHandler](./url-forward-handler.md) - Forward requests to another
  URL
- [urlRewriteHandler](./url-rewrite-handler.md) - Rewrite request URLs
- [webSocketHandler](./websocket-handler.md) - WebSocket connections
- [webSocketPipelineHandler](./websocket-pipeline-handler.md) - WebSocket with
  pipeline support
...
- [Custom Handlers](../articles/custom-handlers) - Building custom handlers
