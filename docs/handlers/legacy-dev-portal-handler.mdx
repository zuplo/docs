...
`foo-123.zuplo.site`). If you've set up a custom domain for your developer
portal, you can specify it in the handler options:
...
2. **Configure Zudoku Base URL**: In your `docs/zudoku.config.ts` file, set the
   `baseUrl` to match the path where your portal will be served:
