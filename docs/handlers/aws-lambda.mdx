...
Note: Many customers use Zuplo's AWS Lambda handler as a replacement for using
...
The IAM user doesn't require console access, only API access. The IAM user used
