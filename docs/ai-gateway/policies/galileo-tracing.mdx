...
3.  ### Configure the policy
        ...
        - **`baseUrl`** (optional): Custom Galileo API endpoint (defaults to `https://api.galileo.ai`)

        :::note

        The `projectId` and `logStreamId` are both found in the URL of the Galileo log stream you want to use. For example: `https://app.galileo.ai/your-app/project/3e71c65e-48b6-4f5d-842d-0851c4704f95/log-streams/f8c71402-1f6b-4f5b-b073-1de999e6a8ea`.
        <br />
