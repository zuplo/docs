...
Apps are in the Zuplo AI Gateway represent any app or integration that will call
the AI Gateway. For example, you might have a custom support chatbot on your
