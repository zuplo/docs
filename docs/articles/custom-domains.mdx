...
1. **API Gateway Custom Domain**: For your API endpoints (e.g.,
...
2. **Developer Portal Custom Domain**: For your developer documentation site
   (e.g., `docs.example.com`). This domain uses the CNAME `cname.zuplodocs.com`.
   Learn more about the Developer Portal in the
...
(e.g. example.com) or subdomain (e.g. api.example.com or docs.example.com).
