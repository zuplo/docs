...
![img](/media/supabase-auth/initial-login.png)
...
![img](/media/supabase-auth/supabase-site-url.png)
...
![img](/media/supabase-auth/dev-portal-updated.png)
...
8. Once deployed, navigate to your Dev Portal (you can find the link the header
   ...
   ![img](/media/supabase-auth/dev-portal-loaded.png)
...
10. A email verification link will be sent to your email. Open the email and
    ...
    ![img](/media/supabase-auth/email.png)
...
![img](/media/supabase-auth/supabase-login.gif)
...
![img](/media/supabase-auth/supabase-github-login.gif)
