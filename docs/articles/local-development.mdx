...
- Use the [local Route Designer](./local-development-routes-designer) to create
  your first route.
- Install [packages](../programmable-api/node-modules.md) to extend your Zuplo
  Gateway.
- Use the [API keys](./local-development-services.md) service locally to secure
  your routes.
- Add [environment variables](./local-development-env-variables.md) to your
  project.
