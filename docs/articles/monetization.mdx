...
[Learn more about monetization with OpenMeter →](./monetization-using-openmeter.mdx)
...
- [Custom pages](../dev-portal/zudoku/guides/custom-pages.mdx) for pricing,
  billing, and account management
- [Custom plugins](../dev-portal/zudoku/custom-plugins.mdx) to integrate billing
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-6">
  <div className="border rounded-lg p-6">
    ...
    <a
      href="./monetization-using-openmeter"
  ...
  <div className="border rounded-lg p-6">
    ...
    <a
      href="https://github.com/zuplo/zuplo/tree/main/examples/metered-monetization"
      className="text-primary hover:underline"
    >
      Browse examples →
    </a>
