...
![Add Policy](/media/step-3-add-api-key-auth/image.png)

Search for the API key authentication policy, click on it, and then click OK to
accept the default policy JSON.

![Add API Key Authentication](/media/step-3-add-api-key-auth/image-1.png)
...
![reorder policies](/media/step-3-add-api-key-auth/image-1.gif)
...
![API Key Service](/media/step-3-add-api-key-auth/image-2.png)

Then click **Create Consumer**.

![Create Consumer](/media/step-2-add-api-key-auth/image-8.png)
...
![New Consumer](/media/step-3-add-api-key-auth/image-3.png)
...
![successful response](/media/step-3-add-api-key-auth/image-6.png)
...
![Developer Portal Endpoint](/media/step-3-add-api-key-auth/image-7.png)
