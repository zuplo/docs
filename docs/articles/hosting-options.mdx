...
We run your gateway in a dedicated, isolated VPC on Akamai connected cloud, AWS,
GCP, Azure, Equinix, TerraSwitch etc. You get to choose the regions you want
your service hosted to meet any sovereignty or data concerns.
