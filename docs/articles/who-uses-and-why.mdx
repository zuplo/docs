...
<!-- vale Vale.Spelling["Yext","Ochsner","iTicket","Waites"] = NO -->

We've customers ranging in size from 1-person startups to mature, large
...
We've many enterprise customers using Zuplo to manage multiple APIs, some
examples include

- [Yext](https://www.yext.com/) a publicly traded company, Yext are the leading
  digital presence platform whose customers include Samsung, Ochsner Health, IHG
  Hotels & Resorts, FedEx and Five Guys.
