...
The following limits apply to Zuplo's managed edge environment. These limits are
fixed for the managed edge service. For managed dedicated environments
(enterprise offering), limits are fully customizable to meet your specific
requirements.
