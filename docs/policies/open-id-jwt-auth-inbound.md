...
For an example of using the user object in a [RequestHandler](/docs/runtime/zuplo-request), see [Setting up JWT auth with Auth0](/docs/policies/auth0-jwt-auth).
