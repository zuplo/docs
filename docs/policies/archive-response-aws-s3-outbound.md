---
title: Archive Response to AWS S3 Policy
sidebar_label: Archive Response to AWS S3
---
...
<CustomPolicyNotice name="Archive Response to AWS S3" id="archive-response-aws-s3-outbound" />
...
```ts title="modules/archive-response-aws-s3-outbound.ts"
