...
// Read the cli.json file (using local file for testing)
console.log("📥 Reading local cli.json file...");
const cliJsonData = await readFile(cliJsonPath, "utf-8");
console.log("✅ Read cli.json successfully\n");

// Parse the cli.json file
