...
export default function Header() {
  ...
  return (
    <header className="max-w-wide sticky top-0 pt-4 mb-4 z-50 w-full [@supports(backdrop-filter:blur(0))]:backdrop-blur-[2px]">
      <div
        className={clsx(
          "max-w-wide flex h-24 w-full flex-none flex-wrap items-center justify-between rounded-xl bg-black/95 px-4 py-5 shadow-md shadow-gray-900/25 transition duration-500 sm:px-6 lg:px-8",
          isScrolled
