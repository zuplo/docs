...
7. The prize draw will include those attendees who complete the [Conference Prize Quickstart](conference-prize.md) and return to the Zuplo booth to show the completed quickstart to the booth staff. Entries must be received by 4pm on October 19. Entries after that time and date will not be included in the draw.
