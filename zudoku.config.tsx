...
posthog.init('phc_xB1aydh7a41MW9TwUtLJjKme4izQiWf9zKbKhpysAiW', { person_profiles: 'always', ui_host: 'https://us.posthog.com', api_host: 'https://now.zuplo.com', defaults: '2025-05-24', disable_session_recording: true })`}
          </script>
          <script>
